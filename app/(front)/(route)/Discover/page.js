      ...
      <div className="lg:flex lg:pl-[292px] pt-7 bg-white text-black">
        ...
        <div className="md:block hidden">
          <ul className="items-center justify-center">
            ...
            <li className="my-1 flex hover:bg-[#E7E9EB] rounded-box w-50 h-10 items-center relative">
              <svg
                width="25px"
                height="25px"
                viewBox="0 0 24 24"
        ...
        <div className="pl-32 lg:hidden ">
          <div className="drawer ">
            ...
            <div className="drawer-content">
              ...
              <label
                htmlFor="my-drawer"
                className="btn btn-[#23272A] drawer-button"
              >
                Categories
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="drawer-side">
              ...
              <ul className="menu p-4 w-80 min-h-full bg-white text-base-content">
                ...
                <li>
                  <Link href="/Dicover">All</Link>
                </li>
                <li>
                  <Link href="/Dicover/Gaming">Gaming</Link>
                </li>
                <li>
                  <Link href="/Dicover/Entertainment">Entertainment</Link>
                </li>
                <li>
                  <Link href="/Dicover/Music">Music</Link>
                </li>
                <li>
                  <Link href="/Dicover/Education">Education</Link>
                </li>
                <li>
                  <Link href="/Dicover/News">News</Link>
                </li>
              </ul>
            </div>
          </div>
